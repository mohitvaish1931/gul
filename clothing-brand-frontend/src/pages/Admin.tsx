                      ...
                      <tr key={order._id} className="hover:bg-white/10 transition-all duration-200 group">
                        ...
                        <td className="px-8 py-4 whitespace-normal">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="text-xs text-text-secondary max-w-50 wrap-break-word">
                        ...
                        <td className="px-8 py-4 whitespace-normal">
                          <div className="flex flex-col max-w-62.5 gap-2">
                            {(order.orderItems || order.items || []).map((it: any, idx: number) => (
                              <div key={idx} className="flex flex-col">
                                <span className="text-xs text-text-secondary font-medium whitespace-normal wrap-break-word">
                                  {it.name} (x{it.qty})
                                </span>
