      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none text-text-primary space-y-8 font-medium">
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Our Commitment</h2>
          ...
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Standards</h2>
            <p className="text-text-secondary">
          ...
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Ongoing Efforts</h2>
            <p className="text-text-secondary">
          ...
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Feedback</h2>
            <p className="text-text-secondary">
