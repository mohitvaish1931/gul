      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none text-text-primary space-y-8 font-medium">
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Professional Cleaning</h2>
            <p className="mb-4 text-text-secondary">
              Most of our ethnic wear, especially those with <span className="text-primary-purple font-bold">Zari, Gotta Patti, or Zardosi work</span>, 
            ...
            <p className="text-text-primary italic">
              <span className="text-primary-purple font-bold">Important:</span> Always inform your dry cleaner about the specific material 
              and embroidery type of your garment for appropriate treatment.
            </p>
          </section>

          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Perfect Storage</h2>
            <p className="mb-4 text-text-secondary">
              Store your precious sarees and lehengas in <span className="text-primary-purple font-bold">Muslin or Cotton bags</span>. 
          ...
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20 shadow-sm">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Ironing & Steaming</h2>
            <p className="mb-4 text-text-secondary">
              Always iron on the <span className="text-primary-purple font-bold">reverse side</span> of the garment. 
          ...
          <section className="bg-white/30 p-8 rounded-2xl border border-gold-primary/20 shadow-sm">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-4 uppercase tracking-wider">Usage & Maintenance</h2>
            <p className="mb-4 text-text-secondary">
          ...
          <section className="pt-12 border-t-2 border-primary-purple/20 text-center">
            <h2 className="luxury-serif text-3xl text-primary-purple mb-6 uppercase tracking-wider">Care Inquiries?</h2>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 text-text-primary font-bold tracking-widest text-sm">
              <div className="bg-white/40 px-8 py-4 rounded-xl border border-gold-primary/20 shadow-sm">
                ...
                <a href="mailto:gulfashionjaipur@gmail.com" className="hover:text-primary-purple transition-all">gulfashionjaipur@gmail.com</a>
              </div>
              <div className="bg-white/40 px-8 py-4 rounded-xl border border-gold-primary/20 shadow-sm">
